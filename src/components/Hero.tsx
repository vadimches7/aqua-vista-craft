  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Премиальный аквариум в современном интерьере"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 rounded-full bg-bio/30 animate-float"
            style={{
              left: `${15 + i * 15}%`,
              top: `${20 + (i % 3) * 25}%`,
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-8 animate-fade-up">
            <div className="w-12 h-12 rounded-xl bg-gradient-bio flex items-center justify-center glow-bio">
              <span className="text-2xl font-serif font-bold text-primary-foreground">B</span>
            </div>
            <span className="text-xl font-semibold tracking-wide">BioCube</span>
          </div>
